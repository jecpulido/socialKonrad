...
class TelefonosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefono" do
    assert_difference('Telefono.count') do
      post telefonos_url, params: { telefono: { Usuario_id: @telefono.Usuario_id, numero: @telefono.numero } }
    end
  ...
  test "should update telefono" do
    patch telefono_url(@telefono), params: { telefono: { Usuario_id: @telefono.Usuario_id, numero: @telefono.numero } }
