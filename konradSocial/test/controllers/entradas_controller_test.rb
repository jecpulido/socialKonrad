...
class EntradasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post entradas_url, params: { entrada: { Usuario_id: @entrada.Usuario_id, fecha: @entrada.fecha, parentId: @entrada.parentId, texto: @entrada.texto } }
    end
  ...
  test "should update entrada" do
    patch entrada_url(@entrada), params: { entrada: { Usuario_id: @entrada.Usuario_id, fecha: @entrada.fecha, parentId: @entrada.parentId, texto: @entrada.texto } }
